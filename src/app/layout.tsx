...
export const metadata: Metadata = {
  title: "Trang & Alfredo's Sequel Celebration | Dec 5, 2026",
  description: "Official Guest Portal & Wedding Operations Platform for Trang & Alfredo's Sequel Wedding Celebration.",
  icons: {
