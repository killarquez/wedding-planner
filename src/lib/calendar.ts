...
export function generateWeddingIcsFile(guestName?: string): string {
  ...
  // End Dec 20, 2026 23:30:00 PST -> 20261221T073000Z
  const startTimeUtc = "20261221T013000Z";
  const endTimeUtc = "20261221T073000Z";
  const uid = `wedding-trang-alfredo-20261220-${Date.now()}@weddingplanner.local`;
...
export function downloadIcsFile(guestName?: string) {
  ...
  link.href = url;
  link.setAttribute('download', 'Trang_Alfredo_Wedding_Dec_20_2026.ics');
