...
export class RsvpPipelineAgent {
  public static async processRsvpSubmission(
    ...
    const smsVi = isAttending
      ? `Chào ${primaryGuest.first_name}! Đã nhận xác nhận tham dự Tiệc Cưới Trang & Alfredo ngày 12/12/2026 (${totalGuests} người). Hẹn gặp bạn!`
